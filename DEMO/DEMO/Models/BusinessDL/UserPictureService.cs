...
//        public async Task<IActionResult> GetProfilePictureAsync(String ASSO_CODE,String COMPANY_NO,string LOCATION_NO)
//        {
//            try
//            {
//                if (string.IsNullOrEmpty(ASSO_CODE))
//                {
...
//                DataSet ds = await _dataLayer.GetDataSetAsync("CBS_HR_GET_USERPICTUREID", parameters);
