...
namespace DEMO.Models.DataDL.Classes
{
        ...
        public class SQLData : OrgChartInterface
        {
            ...
            public async Task<int> ExecuteNonQueryAsync(string procedureName, Hashtable parameters)
            {
                try
                {
                    Conn = Connect();
                    using (SqlCommand cmd = BuildQueryCommand(procedureName, parameters))
                    {
